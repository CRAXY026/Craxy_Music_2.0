...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("Craxy/assets/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('Craxy/assets/font.ttf', 30)
            font2 = ImageFont.truetype('Craxy/assets/font2.ttf', 70)
            font3 = ImageFont.truetype('Craxy/assets/font2.ttf', 40)
            font4 = ImageFont.truetype('Craxy/assets/font2.ttf', 35)

            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "ᴘᴏᴡᴇʀᴇᴅ ʙʏ : ⏤͟͟͞͞ Ｓ Δ Ｈ Ｉ Ｌ ♠", fill="white", font = font1, align ="left") 
...
async def gen_qthumb(videoid):
    try:
        ...
        if 1==1:
            ...
            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "Crax x MUSIC", fill="white", font = font1, align ="left") 
