...
import config
from Craxy import Carbon, YouTube, app
from Craxy.core.call import Crax
from Craxy.misc import db
from Craxy.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from Craxy.utils.exceptions import AssistantErr
from Craxy.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from Craxy.utils.inline.playlist import close_markup
from Craxy.utils.pastebin import Craxbin
from Craxy.utils.stream.queue import put_queue, put_queue_index
from Craxy.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Crax.force_stop_stream(chat_id)
