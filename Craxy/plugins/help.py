...
from Craxy.utils import help_pannel
from Craxy.utils.database import get_lang, is_commanddelete_on
from Craxy.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from Craxy.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_sticker("CAACAgUAAxkBAAEBGppjkXBp9C49qFGyyIsjA_7IJedXGQACkQgAAs-LkFRxEdJKufemvCsE")
