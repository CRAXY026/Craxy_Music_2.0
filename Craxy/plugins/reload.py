...
from Craxy.utils.database import get_authuser_names, get_cmode
from Craxy.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Craxy.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Crax.stop_stream(message.chat.id)
    except:
        pass
