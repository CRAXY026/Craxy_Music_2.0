...
from Craxy.utils import get_readable_time
from Craxy.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
                                       remove_banned_user)
from Craxy.utils.decorators.language import language
...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgQAAxkBAAENb_xjjPJB5BlSKVHUkiUy553S5AwnhQACJg4AAhII-FHinHP6oYmxSCsE")
