...
from Craxy import Telegram, YouTube, app
from Craxy.misc import SUDOERS
from Craxy.plugins.playlist import del_plist_msg
from Craxy.plugins.sudoers import sudoers_list
from Craxy.utils.database import (add_served_chat,
                                       add_served_user,
                                       blacklisted_chats,
                                       get_assistant, get_lang,
                                       get_userss, is_on_off,
                                       is_served_private_chat)
from Craxy.utils.decorators.language import LanguageStart
from Craxy.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgQAAxkBAAENbOBjjGIVn73zmutviRbMpJQD3UwGRgAC2goAAsuzCVMVR5rqAluF-SsE")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/akkkasimp) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
